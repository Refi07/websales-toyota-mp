...
<div class="bg-neutral-950 text-white min-h-screen antialiased relative overflow-hidden flex items-center justify-center">
    ...
    <div class="max-w-7xl mx-auto px-6 py-20 sm:px-8 lg:px-12 flex flex-col items-center justify-center text-center relative z-10">
        ...
        <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center w-full sm:w-auto">
            <a href="{{ route('toyota.contact') }}" class="px-8 py-3.5 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg shadow-lg shadow-red-600/30 transition-all duration-300 transform hover:-translate-y-0.5 tracking-wide text-center w-full sm:w-auto">
                Minta Brosur
            </a>
            <a href="{{ route('toyota.products') }}" class="px-8 py-3.5 bg-slate-800/80 hover:bg-slate-700 text-slate-200 font-medium rounded-lg border border-slate-700 transition-all duration-300 text-center w-full sm:w-auto">
                Lihat Produk
            </a>
        </div>
    </div>
